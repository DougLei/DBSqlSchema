...
import com.sql.impl.statement.complex.object.procedure.model.step.entity.logic.rollback.ORACLE_ROLLBACK;
import com.sql.impl.statement.complex.object.procedure.model.step.entity.logic.rollback.SQLSERVER_ROLLBACK;
