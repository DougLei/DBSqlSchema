...
import com.sql.impl.statement.complex.object.procedure.model.step.entity.execprop.ExecPropStepEntity;
...
public class ExecPropStepEntityFactory implements StepEntityFactory {
	...
	public StepEntity buildEntity(JSONObject stepContent) {
		return new ExecPropStepEntity(stepContent.getJSONArray("condition"));
	}
}
