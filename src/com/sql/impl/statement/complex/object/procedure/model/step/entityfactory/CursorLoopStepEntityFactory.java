...
import com.sql.impl.statement.complex.object.procedure.model.step.entity.cursorloop.CursorLoopEntity;
...
public class CursorLoopStepEntityFactory implements StepEntityFactory {
	...
	public StepEntity buildEntity(JSONObject stepContent) {
		...
		cursorLoopStepEntity.setCursorEntity(new CursorLoopEntity(stepContent.getJSONObject("cursor"), stepContent.getJSONArray("content")));
